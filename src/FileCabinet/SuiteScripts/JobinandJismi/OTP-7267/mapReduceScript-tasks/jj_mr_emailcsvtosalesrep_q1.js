 ...
 */
    (email, file, format, log, record, runtime, search) => {
        ...
        const reduce = (reduceContext) => {
            ...
            var salesRepId = reduceContext.key;
            var salesRepData = reduceContext.values.map(JSON.parse);
            ...
            var recipientEmail = salesRepId === 'admin' ? -5 : search.lookupFields({
                type: search.Type.EMPLOYEE,
                id: salesRepId,
                columns: ['email']
            }).email;
 
            var subject = 'Monthly Sales Data';
            var body = salesRepId === 'admin' ?
